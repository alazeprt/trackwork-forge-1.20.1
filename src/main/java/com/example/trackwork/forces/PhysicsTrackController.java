package com.example.trackwork.forces;
...
public class PhysicsTrackController implements ShipForcesInducer {
   ...
   public boolean equals(Object other) {
      if (this == other) {
         ...
         return other instanceof PhysicsTrackController otherController && Objects.equals(this.trackData, otherController.trackData)
